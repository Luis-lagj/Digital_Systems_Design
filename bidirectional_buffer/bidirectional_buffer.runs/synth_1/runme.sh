...
HD_PWD='C:/Users/luish/OneDrive/Desktop/bidirectional_buffer/bidirectional_buffer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bidirectional_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bidirectional_buffer.tcl
