...
HD_PWD='C:/Users/luish/OneDrive/Desktop/bidirectional_buffer/bidirectional_buffer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bidirectional_buffer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bidirectional_buffer.tcl -notrace
