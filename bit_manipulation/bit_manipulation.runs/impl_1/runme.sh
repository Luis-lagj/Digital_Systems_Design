...
HD_PWD='C:/Users/luish/OneDrive/Desktop/bit_manipulation/bit_manipulation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_manipulation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_manipulation.tcl -notrace
