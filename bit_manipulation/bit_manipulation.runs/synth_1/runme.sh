...
HD_PWD='C:/Users/luish/OneDrive/Desktop/bit_manipulation/bit_manipulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_manipulation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_manipulation.tcl
