...
HD_PWD='C:/repo/systemverilog/l_00_gate level/l_00_gate level.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eq_comp_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eq_comp_2bit.tcl
