...
HD_PWD='C:/repo/systemverilog/l_00_gate level/l_00_gate level.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eq_comp_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eq_comp_2bit.tcl -notrace
